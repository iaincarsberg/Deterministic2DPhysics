...
namespace SveltoDeterministic2DPhysicsDemo.Physics.EntityComponents
{
    ...
    {
        public static RigidbodyEntityComponent From(FixedPointVector2 direction, FixedPoint speed, FixedPoint restitution, FixedPoint mass, bool isKinematic)
        {
            return new RigidbodyEntityComponent(
                speed, 
                direction, 
                FixedPointVector2.Zero, 
                FixedPoint.Zero, 
                restitution, 
                mass,
                isKinematic
        ...
        private RigidbodyEntityComponent(FixedPoint speed, FixedPointVector2 direction, FixedPointVector2 velocity, FixedPoint potential, FixedPoint restitution, FixedPoint mass, bool isKinematic)
        {
            Speed = speed;
            Direction = direction;
            Velocity = velocity;
        ...
        public RigidbodyEntityComponent CloneAndReplaceVelocityAndPotential(FixedPointVector2 velocity, FixedPoint potential)
        {
            return new RigidbodyEntityComponent(Speed, Direction, velocity, potential, Restitution, Mass, IsKinematic);
        }
