...
namespace SveltoDeterministic2DPhysicsDemo.Graphics
{
    ...
    {
        private readonly Dictionary<int, IntPtr> _fontPoints = new Dictionary<int, IntPtr>();
        ...
        public bool Init()
        {
            ...
            if ((_renderer = SDL.SDL_CreateRenderer(_window, -1, SDL.SDL_RendererFlags.SDL_RENDERER_ACCELERATED)) == IntPtr.Zero)
            {
        ...
        public void DrawTextAbsolute(Colour color, int x, int y, string text, int ptSize = 12)
        {
            ...
            var surfaceMessage = SDL_ttf.TTF_RenderText_Solid(font, text, new SDL.SDL_Color {r = rgb[0], g = rgb[1], b = rgb[2], a = 255});
            ...
            var rectMessage = new SDL.SDL_Rect {x = x, y = y, w = w, h = h}; 
        ...
        private IntPtr GetFont(int ptSize)
        {
