...
namespace Svelto.ECS
{
    ...
    public readonly ref struct EntityCollection<T1, T2, T3, T4, T5> 
                                                            where T1 : struct, IEntityComponent
                                                            where T2 : struct, IEntityComponent
    ...
    {
        internal EntityCollection
            (in EntityCollection<T1> array1, in EntityCollection<T2> array2, in EntityCollection<T3> array3, in EntityCollection<T4> array4, in EntityCollection<T5> array5)
        {
            _array1 = array1;
            _array2 = array2;
            _array3 = array3;
        ...
        internal EntityCollection<T5> Item5
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => _array5;
        }
