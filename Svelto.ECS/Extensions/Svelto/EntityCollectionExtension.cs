...
namespace Svelto.ECS
{
    ...
    public static class EntityCollectionExtensionD
    {
       ...
       , out MB<T4> buffer4, out int count) where T1 : unmanaged, IEntityComponent
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BT<NB<T1>, NB<T2>, NB<T3>, NB<T4>, NB<T5>> ToBuffers<T1, T2, T3, T4, T5>
            (in this EntityCollection<T1, T2, T3, T4, T5> ec)
            where T2 : unmanaged, IEntityComponent
            where T1 : unmanaged, IEntityComponent
            where T3 : unmanaged, IEntityComponent
            where T4 : unmanaged, IEntityComponent
        ...
        {
            return new BT<NB<T1>, NB<T2>, NB<T3>, NB<T4>, NB<T5>>(ec.Item1._nativedBuffer, ec.Item2._nativedBuffer
                , ec.Item3._nativedBuffer, ec.Item4._nativedBuffer, ec.Item5._nativedBuffer, ec.count);
        }
    }
}