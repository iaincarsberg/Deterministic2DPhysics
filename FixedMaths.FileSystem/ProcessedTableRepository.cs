...
namespace FixedMaths.FileSystem
{
    public class ProcessedTableRepository : IProcessedTableRepository
    {
        ...
        private readonly Dictionary<Operation, Dictionary<int, int>> _data;
        
        private ProcessedTableRepository(Dictionary<Operation, Dictionary<int, int>> data)
        {
            _data = data;
        }
        ...
        public Dictionary<FixedPoint, FixedPoint> CalculateAcoshData()
        {
            ...
            return data.ToDictionary(x => FixedPoint.FromExplicit(x.Key), x => FixedPoint.FromExplicit(x.Value), FixedPointEqualityComparer.Instance);
        }
        ...
        public Dictionary<FixedPoint, FixedPoint> CalculateCosData()
        {
            ...
            return data.ToDictionary(x => FixedPoint.From(x.Key), x => FixedPoint.FromExplicit(x.Value), FixedPointEqualityComparer.Instance);
        }
        ...
        private Dictionary<int, int> GetTableDto(Operation operation)
        {
