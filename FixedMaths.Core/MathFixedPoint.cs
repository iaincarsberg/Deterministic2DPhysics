...
namespace FixedMaths.Core
{
    ...
    {
        private static readonly FixedPoint TrigonometricSteps = FixedPoint.From(MathFixedPointConstants.TrigonometricSteps);
        private static readonly FixedPoint HyperbolicMediumResolution = FixedPoint.FromExplicit(MathFixedPointConstants.HyperbolicMediumResolution);
        private static readonly FixedPoint HyperbolicLowResolution = FixedPoint.FromExplicit(MathFixedPointConstants.HyperbolicLowResolution);
        private static readonly FixedPoint HyperbolicHighResolutionStep = FixedPoint.FromExplicit(MathFixedPointConstants.HyperbolicHighResolutionStep);
        private static readonly FixedPoint HyperbolicMediumResolutionStep = FixedPoint.FromExplicit(MathFixedPointConstants.HyperbolicMediumResolutionStep);
        private static readonly FixedPoint HyperbolicLowResolutionStep = FixedPoint.FromExplicit(MathFixedPointConstants.HyperbolicLowResolutionStep);
        private static readonly FixedPoint SqrtMediumResolution = FixedPoint.FromExplicit(MathFixedPointConstants.SqrtMediumResolution);
        private static readonly FixedPoint SqrtLowResolution = FixedPoint.FromExplicit(MathFixedPointConstants.SqrtLowResolution);
        private static readonly FixedPoint SqrtHighResolutionStep = FixedPoint.FromExplicit(MathFixedPointConstants.SqrtHighResolutionStep);
        private static readonly FixedPoint SqrtMediumResolutionStep = FixedPoint.FromExplicit(MathFixedPointConstants.SqrtMediumResolutionStep);
        private static readonly FixedPoint SqrtLowResolutionStep = FixedPoint.FromExplicit(MathFixedPointConstants.SqrtLowResolutionStep);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FixedPoint Magnitude(FixedPointVector2 v)
        {
            return Sqrt(FixedPointVector2.Dot(v, v));
        }
        ...
        public static FixedPoint RoundToNearestStep(FixedPoint fp, FixedPoint step)
        {
            ...
            return fp - floored > step / FixedPoint.Half
                ? floored + step
                : floored;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static FixedPoint TrigonometricLookup(FixedPoint fp, IReadOnlyDictionary<FixedPoint, FixedPoint> data)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static FixedPoint HyperbolicLookup(FixedPoint fp, IReadOnlyDictionary<FixedPoint, FixedPoint> data, FixedPoint nanIfLessThan)
        {
            if (fp < nanIfLessThan)
            {
                return FixedPoint.NaN;
